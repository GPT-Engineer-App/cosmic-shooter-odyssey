...
**Project**: cosmic-shooter-odyssey 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: make a full screen 1st persin shooter game in 3d space  
...
```sh
git clone https://github.com/GPT-Engineer-App/cosmic-shooter-odyssey.git
cd cosmic-shooter-odyssey
npm i
